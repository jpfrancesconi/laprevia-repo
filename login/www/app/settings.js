...
Drupal.settings.site_path = 'http://192.168.1.99/laprevia'; // e.g. http://www.example.com
...
drupalgap.settings.offline_message = 'No hay conexión!';

// Exit app message.
drupalgap.settings.exit_message = 'Salir ' + drupalgap.settings.title + '?';
...
drupalgap.settings.menus['user_menu_authenticated'] = {
  ...
  links: [
    {
    	title: 'Mi Perfil',
        path: "user/'+ Drupal.user.uid +'/edit",
        options: {
          attributes: {
            'data-icon': 'user'
          }
